...
```bash
git clone https://github.com/yourusername/AIR-WEATHER-INFO-USING-IQAIR-API.git
cd AIR-WEATHER-INFO-USIN-IQAIR-API
```
...
3. Create a `.env` file and add your IQAir API key:
```
...
- Thanks to IQAir for providing access to their API
